...
public class BluetoothCommService {
     ...
     * (or until cancelled).
     */
    //****************THIS THREAD MIGHT NOT BE NECESSARY
            ...
            try {
                //if (secure) {
                    tmp = mAdapter.listenUsingRfcommWithServiceRecord(NAME_SECURE,
                        MY_UUID_SECURE);
      //******listenUsingInsecureRfcommWithServiceRecord not working
                /*} else {
    ...
    private class ConnectedThread extends Thread {
        ...
        public void run() {
            ...
            //Byte used to initialize the data format 8
            byte[] initialize = {0x02, 0x70, 0x04, 0x02, 0x08, 0x00, 0x7e, 0x03};
            byte[] helloworld = {0x48 , 0x65 , 0x6C , 0x6C , 0x6F , 0x2C , 0x20 , 0x77 , 0x6F , 0x72, 0x6C , 0x64 , 0x21, 0x24};
            Log.i(TAG, "Declared initialize byte");
            int bytes;
